...
class _AssignmentDetailBody extends StatelessWidget {
  ...
  IconData get _deviceIcon => switch (assignment.deviceName?.toLowerCase()) {
        ...
        final n when n != null && n.contains('telefon') => Icons.smartphone_outlined,
        _ => Icons.devices_outlined,
      };

  String get _typeLabel => assignmentTypeLabels[assignment.type] ?? 'Zimmet';

  String get _returnConditionLabel =>
      assignment.returnCondition != null
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              // Zimmet bilgileri
              _Card(title: 'ZİMMET BİLGİLERİ', children: [
                _KvRow('Zimmet Tarihi', _dateFmt.format(a.assignedAt)),
                if (a.expectedReturnDate != null)
                  _KvRow('Beklenen İade', _dateFmt.format(a.expectedReturnDate!)),
                  ...
                  child: _Card(
                    ...
                    children: [
                      Row(
                        children: [
                          Container(
                            ...
                            child: Icon(_deviceIcon, size: 20, color: AppColors.navy),
                          ),
                      ...
                      if (a.deviceBrand != null || a.deviceModel != null) ...[
                        const SizedBox(height: 12),
                        _KvRow('Marka / Model',
                            [a.deviceBrand, a.deviceModel].whereType<String>().join(' ')),
                      ],
                              ...
                              children: [
                                ...
                                Text(
                                  [
                                    ...
                                    if (a.employeeDepartment != null) a.employeeDepartment!,
                                  ].join(' · '),
                                  style: GoogleFonts.inter(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('İade Et', style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
                onPressed: () async {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 110,
            child: Text(k, style: GoogleFonts.inter(
