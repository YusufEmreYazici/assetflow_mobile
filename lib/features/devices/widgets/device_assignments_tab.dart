...
final _deviceAssignmentsProvider =
    FutureProvider.autoDispose.family<List<Assignment>, String>((ref, deviceId) async {
        ...
        return ListView(
          ...
          children: [
            if (active.isNotEmpty) ...[
              ...
              ...active.map((a) => _AssignmentCard(assignment: a, isActive: true)),
              if (past.isNotEmpty) const SizedBox(height: 16),
            ],
            if (past.isNotEmpty) ...[
              _SectionLabel('GEÇMİŞ ZİMMETLER'),
              const SizedBox(height: 8),
              ...past.map((a) => _AssignmentCard(assignment: a, isActive: false)),
            ],
          ],
        );
      },
