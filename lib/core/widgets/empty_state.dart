...
class EmptyState extends StatelessWidget {
  ...
  const EmptyState.noEmployees({
    ...
    VoidCallback? onAdd,
        ...
        description = 'Sisteme personel ekleyerek cihaz zimmetlemeye başlayabilirsin.',
  ...
  const EmptyState.filterNoResults({
    super.key,
  ...
  const EmptyState.noLocations({
    ...
    VoidCallback? onAdd,
        ...
        title = 'Lokasyon yok',
        description = 'Henüz lokasyon eklenmemiş. Cihazları konumlarına göre gruplamak için lokasyon ekle.',
